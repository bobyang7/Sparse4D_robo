...
LGD 1.89
"""
# baseline是在复现的ckpt基础上，多训练5个epoch看损失的变化
# ================ base config ===================
plugin = True
...
kalman_filter = False
freeze_all_except_kal = False
work_dir = "work_dirs/baseline/vov"
load_from = "/home/bo.yang5/streampetr/ckpts/fcos3d_vovnet_imgbackbone-remapped.pth"
# resume_from = "/home/bo.yang5/other/Sparse4D-full/work_dirs/sparse4dv3_temporal_r50_1x8_bs6_256x704/iter_43900.pth"
resume_from = None
...
optimizer_config = dict(
    ...
    freeze_all_except_kal=freeze_all_except_kal,
)
lr_config = dict(
